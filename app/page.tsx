...
const EMAIL = "amanniju2@gmail.com";
          ...
          >
            ...
            <div className="mt-2 md:mt-20">
              ...
              <h1 className="text-6xl sm:text-7xl md:text-8xl lg:text-[8.5rem] font-bold tracking-[-0.03em] text-ice-50 leading-[0.92] whitespace-nowrap">
                <HeroWord text="Aman" delay={120} />
                <br />
                <HeroWord text="Kumar" delay={260} className="text-ice-400" />
              </h1>
              <p
              ...
              >
                ...
                <a
                  href="https://leetcode.com/u/L63PLdQFCF/"
                  target="_blank"
                  rel="noopener noreferrer"
                  data-cursor="hover"
                  data-magnetic
                  ...
                  aria-label="LeetCode"
                >
                  <svg viewBox="0 0 128 128" width="16" height="16" aria-hidden>
                ...
                <a
                  href="https://www.linkedin.com/in/aman-singh-156799370"
                  target="_blank"
                  rel="noopener noreferrer"
                  data-cursor="hover"
                  data-magnetic
                ...
                <a
                  href="https://github.com/aman-dev-maker"
                  target="_blank"
                  rel="noopener noreferrer"
                  data-cursor="hover"
                  data-magnetic
